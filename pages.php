...
<head>
  ...
  <title>PT BIMA BHAKTI UTAMA</title>
...
<link href='logo-icn.png' rel='icon'>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>BBU</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>B&nbsp;&nbsp;&nbsp;B&nbsp;&nbsp;&nbsp;U</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="logo-icn.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Teknisi</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="logo-icn.png" class="img-circle" alt="User Image">
  ...
  else if (isset($_SESSION['user_admin']) and isset($_SESSION['pass_admin'])) {
  ...
  else if (isset($_SESSION['user_admin_sales']) or isset($_SESSION['pass_admin_sales'])) {
			  require('sidebar_admin_sales.php');
  }
  else if (isset($_SESSION['user_cs']) or isset($_SESSION['pass_cs'])) {
			  require('sidebar_cs.php');
  }
  else if (isset($_SESSION['user_manajer_keuangan']) or isset($_SESSION['pass_manajer_keuangan'])) {
			  require('sidebar_manajer_keuangan.php');
  }
  ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://www.bimabhaktiutama.com/" target="_blank">PT Bima Bhakti Utama</a>.</strong> All rights
    reserved.
  </footer>
